        ...
        <div className="grid lg:grid-cols-12 gap-12 items-start">
          <Reveal className="lg:col-span-5" y={20}>
            <div className="relative">
              <Tilt className="mb-6" maxTilt={8}>
                <div className="panel bracket p-1.5">
                  <div className="relative overflow-hidden aspect-[4/3]" style={{ transformStyle: "preserve-3d" }}>
                    <img
                      src={profile.photo}
                      alt={profile.name}
                      className="w-full h-full object-cover object-top grayscale-[30%] contrast-[1.05]"
                      style={{ transform: "translateZ(24px) scale(1.12)" }}
                      loading="lazy"
                    />
                    <div
                    ...
                    />
                    <span
                      className="absolute bottom-3 left-3 font-mono-tag text-[10px] uppercase tracking-widest text-lime-400 bg-void/70 px-2 py-1"
          ...
          <Reveal className="lg:col-span-7" delay={0.15} y={20}>
